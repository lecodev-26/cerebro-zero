...
class CNNLite:
    def __init__(self):
        # Red más pequeña para móvil
        self.conv1 = Conv2D(1, 4, 3, 1, 1)
        self.pool1 = MaxPool2D(2, 2)
        self.conv2 = Conv2D(4, 8, 3, 1, 1)
        self.pool2 = MaxPool2D(2, 2)
        self.fc1 = LinearNumpy(8 * 7 * 7, 16)
        self.fc2 = LinearNumpy(16, 10)
        self.relu = ReLUNumpy()
    ...
    def guardar(self, nombre="cnn_mnist_lite.pkl"):
        with open(nombre, 'wb') as f:
            ...
            pickle.dump(data, f)
        print(f"💾 CNN Lite guardada en {nombre}")

def entrenar_mnist_lite():
    print("🧠 ENTRENANDO CNN LITE CON MNIST")
    print("="*40)
    ...
    try:
        ...
        print("   Ejecuta: python datos/descargar_mnist.py")
        return
    
    # Usar solo 2000 ejemplos para que sea rápido
    ...
    print(f"   Modelo: CNN Lite (4→8 filtros)")
